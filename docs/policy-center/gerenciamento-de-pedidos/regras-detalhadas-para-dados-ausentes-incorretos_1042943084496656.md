...
**(1) Item/cor/padrão/formato incorreto**

* O comportamento ocorre quando o produto entregue pelo vendedor não corresponde ao estilo, à cor, ao padrão, ao formato, etc., do produto no pedido de compra real do cliente.

**(2) Tamanho/dimensão/especificação/peso incorretos**

* O comportamento em que os produtos entregues pelo vendedor não correspondem ao tamanho, às dimensões, às especificações, ao peso, etc., dos produtos no pedido de compra real do cliente.

**(3) Produto/brinde/acessório ausente**

* O comportamento em que a quantidade de produtos entregues pelo vendedor não corresponde à quantidade de produtos/brindes/acessórios no pedido de compra do cliente, etc.
...
| Item/cor/estampa/formato incorreto | * A página de detalhes do produto exibe um conjunto de "sling e calça comprida", mas o consumidor recebe um conjunto de "colete e shorts". * A página de detalhes do produto anuncia o produto como um cinto, mas o consumidor recebe uma máscara. * O consumidor pediu um copo de água rosa, mas recebeu um preto. | Exemplo de cor errada:imageimage |
| Produto enviado com tamanho/dimensões/especificações/peso incorretos | * A página de detalhes do produto exibe uma mochila escolar com dimensões de 28 cm×14 cm×40 cm, mas o consumidor recebe uma mochila escolar com dimensões de 20 cm×10 cm×30 cm. * O consumidor pediu uma calça tamanho G, mas recebeu uma calça tamanho GG. | Exemplo de tamanho incorreto:O cliente encomendou sapatos no tamanho 35/36, mas recebeu sapatos no tamanho 33/34. image |
| Produto/brinde/acessório ausente | * A página de detalhes do produto exibe um conjunto de "uma escova de dentes elétrica + três refis", mas o consumidor recebe apenas uma escova de dentes elétrica sem os acessórios anunciados. * O consumidor encomendou três casacos, mas recebeu apenas dois, faltando um. | Exemplo de acessórios ausentes:imageimage |

# Medidas de fiscalização para violações

A plataforma identifica o feedback negativo dos consumidores em relação a problemas como envios incorretos ou ausentes em vários canais, incluindo avaliações de pedidos, serviços pós-venda e reclamações. Caso haja um grande volume e uma alta proporção de feedback negativo, a plataforma se reserva o direito de tomar as medidas corretivas correspondentes, de acordo com os cenários de violação listados na tabela abaixo.  

|  |  |
| --- | --- |
| **Cenários de violação** | **Tratamento de violações** |
| Circunstâncias menores | Advertência |
| Circunstâncias gerais | Limite de exibição, desativação de produtos,congelamento de produtos |
| Circunstâncias graves | Limite de exibição, congelamento de produtos, dedução do índice de integridade da conta (AHR) do vendedor |
