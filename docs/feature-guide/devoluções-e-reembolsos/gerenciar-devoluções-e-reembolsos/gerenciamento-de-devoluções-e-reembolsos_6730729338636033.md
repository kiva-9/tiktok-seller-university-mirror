...
Nesta página, você verá diferentes abas que categorizam os pedidos conforme os diferentes estágios do processo:  

![image](https://p16-oec-university-sign-sg.ibyteimg.com/tos-alisg-i-nk3i2mqmvs-sg/2a5d36b81a4e431ca4881ae173ace792~tplv-nk3i2mqmvs-image.png?lk3s=5d1a069b&x-expires=2068158268&x-signature=4GjgVAlgf0D5upQf4UnxOXTjelY%3D)

![image](https://p16-oec-university-sign-sg.ibyteimg.com/tos-alisg-i-nk3i2mqmvs-sg/29d914fd6c094a93bb3ee8e1d9048e05~tplv-nk3i2mqmvs-image.png?lk3s=5d1a069b&x-expires=2068158267&x-signature=1CwFckk2cKYDg%2BBFGkKQOWHR%2BTY%3D)

Você verá então a nova aba **Aguardando sua ação**, equipada com quatro filtros rápidos para ajudar a priorizar tarefas importantes e mantê-lo atualizado, garantindo que nenhuma ação necessária da sua parte seja esquecida.  
Se você tiver uma solicitação em andamento e acreditar que não é necessário aguardar o resultado do processamento da plataforma — e concordar em reembolsar o comprador — você pode clicar em “Emitir Reembolso” para prosseguir. Por favor, note que, nesse caso, o valor do reembolso será arcado por você.   
Se preferir aguardar a conclusão do processo pela plataforma, basta esperar pelo resultado. Caso a plataforma precise de mais informações ou alguma ação da sua parte, a solicitação aparecerá na aba “Aguardando Sua Ação”"  
Esses novos filtros rápidos incluem:  

![image](https://p16-oec-university-sign-sg.ibyteimg.com/tos-alisg-i-nk3i2mqmvs-sg/3f458b5a5a1242ceaeacdf9164745ca8~tplv-nk3i2mqmvs-image.png?lk3s=5d1a069b&x-expires=2068158265&x-signature=qAHs4jXhAHvTsZVDcjfFlcAJIBc%3D)
...
💡**Dica para o vendedor:** Agilize a gestão de devoluções e reembolsos com nossos filtros aprimorados. O novo filtro oferece mais opções, facilitando o refinamento dos resultados.  
...
* Se a solicitação for **rejeitada pela primeira vez**, o comprador pode **enviar uma nova solicitação** ou **abrir uma disputa**.
* Se a solicitação for **rejeitada duas vezes para o mesmo pedido**, o comprador só poderá **abrir uma disputa**.
* Quando o comprador abre uma disputa, **TikTok irá intermediar** o caso entre você e o comprador para encontrar uma solução justa.

  ![image](https://p16-oec-university-sign-sg.ibyteimg.com/tos-alisg-i-nk3i2mqmvs-sg/4a659001b75a4288825300c807207de1~tplv-nk3i2mqmvs-image.png?lk3s=5d1a069b&x-expires=2068158264&x-signature=Qm0Y%2B73yjG34jQRrTPBUClnVYyA%3D)

## FAQ

1. **Posso modificar ou atualizar minha resposta a uma solicitação de devolução ou reembolso depois de enviá-la?**

Sim, você pode modificar ou atualizar sua resposta a uma solicitação de devolução ou reembolso mesmo após o envio.

2. **Existe um limite de vezes que o comprador pode contestar uma solicitação rejeitada?**

Sim, os compradores podem contestar uma solicitação rejeitada até **2 vezes**.

3. **Há alguma situação em que posso estender o prazo de 1 dia corrido para responder às solicitações em “Aguardando sua ação”?**

Não. A plataforma TikTok **aprovará automaticamente** a solicitação do comprador em **1 dia corrido** se o vendedor não responder dentro do prazo.
